"""BioViLEncoder adapter.

BioViL은 radiology image-text representation learning baseline으로 사용할 수 있다.
...
class BioViLEncoder(BaseVisionEncoder):
    ...
    def encode_image(self, frontal_path: str, lateral_path: str | None = None) -> np.ndarray:
        raise NotImplementedError("BioViLEncoder.encode_image를 실제 모델 환경에 맞게 구현하세요.")

    def encode_text(self, text: str) -> np.ndarray:
        raise NotImplementedError("BioViLEncoder.encode_text를 실제 모델 환경에 맞게 구현하세요.")
